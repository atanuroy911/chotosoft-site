            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 gap-20">
                    <div className="flex flex-col md:flex-row-reverse justify-between w-fit">
                        ...
                        <Image src="product-2.png" alt="Work 1" className="h-auto md:w-1/3 lg:w-sm lg:mx-20 object-cover transition-all duration-300 rounded-lg cursor-pointer hover:scale-105 " />
                    </div>
                    <div className="flex flex-col md:flex-row justify-between">
                        ...
                        <Image src="product-1.png" alt="Work 2" className="h-auto md:w-1/3 lg:w-sm lg:mx-20 object-cover transition-all duration-300 rounded-lg cursor-pointer hover:scale-105" />
                    </div>
                    ...
                    <div className="flex flex-col md:flex-row-reverse justify-between w-fit">
                        ...
                        <Image src="product-3.png" alt="Work 3" className="h-auto md:w-1/3 lg:w-sm lg:mx-20 object-cover transition-all duration-300 rounded-lg cursor-pointer hover:scale-105" />
                    </div>
