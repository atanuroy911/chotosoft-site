...
const LogoCarousel: React.FC = () => {
    useEffect(() => {
        const originalList = document.querySelector('.animate-infinite-scroll');
    ...
    return (
        <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
            <ul className="flex items-center justify-center md:justify-start [&_li]:mx-8 [&_img]:max-w-none animate-infinite-scroll">
                <li>
                    <img src="Brands-1.png" alt="Image 1" className="w-28 h-auto" />
                </li>
                <li>
                    <img src="Brands-2.png" alt="Image 2" className="w-28 h-auto" />
                </li>
                <li>
                    <img src="Brands-3.png" alt="Image 3" className="w-28 h-auto" />
                </li>
                <li>
                    <img src="Brands-4.png" alt="Image 4" className="w-28 h-auto" />
                </li>
                <li>
                    <img src="Brands-5.png" alt="Image 5" className="w-28 h-auto" />
                </li>
            </ul>
